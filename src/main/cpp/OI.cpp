...
void OI::MapControllerButtons() {
    ...
    //manipulator
    SimpleButton(manipulatorController, Xbox::X_button).WhenPressed(new LowerClimber);
    SimpleButton(manipulatorController, Xbox::Y_button).WhenPressed(new RaiseClimber);
